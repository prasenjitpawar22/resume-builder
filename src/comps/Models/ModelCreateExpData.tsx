          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <form onSubmit={handleSubmit} className='bg-white rounded px-8 pt-6 pb-2 mb-4'>
              ...
              <div className="flex items-center justify-end p-2 border-t border-solid border-slate-200 rounded-b">
                ...
                <button
                  className="bg-component-secondary text-white active:bg-component-primary hover:bg-component-primary font-bold
                   uppercase text-sm px-6 py-2 rounded shadow hover:shadow-lg 
