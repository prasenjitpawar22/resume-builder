    ...
    <>
      <div className='absolute overflow-hidden w-full h-full flex flex-wrap  '>
        <motion.div className=''
          ...
          <motion.div className='absolute top-0 h-fit w-fit phone:-top-48 phone:-left-20'>
          ...
          <motion.div className='absolute bottom-0 right-0 phone:-bottom-48 phone:-right-20 h-fit w-fit'
